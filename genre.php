...
<body class="bg-gray-200">
    ...
    <nav class="navbar-sticky bg-white sticky w-full z-10 top-0 left-0 right-0 border-b border-gray-200;">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <div class="justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul class="items-center flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-64 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                <li>
                    <a href="" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0" aria-current="page">Fantasi</a>
                </li>
                <li>
                    <a href="" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Aksi</a>
                </li>
                <li>
                    <a href="" class="block py-2 px-3 text-black bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0">Misteri</a>
                </li>
                <li>
                    <a href="" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Horor</a>
                </li>
                <li> 
                    <a href="" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Komedi</a>
                </li>
                <li>
                    <a href="" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Romantis</a>
                </li>
                </ul>
            </div>
        </div>
    ...
    <main> 
        ...
        <div class="mt-5 p-5 font-inter grid grid-cols-3 gap-2 md:grid-cols-5">
            <div class="h-15 bg-blue-200 aspect-square rounded-lg"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg col-start-3 md:col-start-5"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg col-start-3 md:col-start-2"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg"></div>
            <div class="h-15 bg-blue-200 aspect-square rounded-lg"></div>
