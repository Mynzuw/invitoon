...
?>
      <tr class="bg-white dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-white-200">
        ...
        <td class="px-6 py-4 border border-b-indigo-200"><?= $row["deskripsi"] ?></td>
...
</form><button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" data-modal-target="crud-modal-edit<?= $row["komik_id"] ?>" data-modal-toggle="crud-modal-edit<?= $row["komik_id"] ?>">Edit</button>
