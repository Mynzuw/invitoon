...
<body>
    <header>
    <nav class="bg-white fixed relative top-0 w-full z-20 top-0 start-0 border-b border-gray-200">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                ...
                <li>
                    <a href="#" class="block py-2 px-3 text-black bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0" aria-current="page">Home</a>
                </li>
                <li>
                    <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Genre</a>
                </li>
                <li>
                    <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Rekomendasi</a>
                </li>
            </div>
        </div>
    </nav>
            ...
            <div class="col-span-10">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="col-span-1 border-2 rounded-md py-2 px-4 max-h-[538px] overflow-y-auto">
                        <h1 class="text-2xl font-extrabold">Trending</h1>
