...
<body>
    <nav class="navbar-sticky bg-white sticky w-full z-50 top-0 left-0 right-0 border-b border-gray-200;">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="py-2 px-3">
                <button type="button" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 px-4 border border-blue-700 rounded">Masuk</button>
            </div>
                                ...
                                <div class="max-w-sm bg-white border-bl-2 border-br-2 border-gray-300 rounded-lg shadow-lg">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="flex items-center mb-5">
                                            ...
                                            <a href="chapter.php?komik_id=<?= $row["komik_id"] ?>" class="text-sm font-medium text-gray-900 ">73 Chapter</a>
                                        </div>
