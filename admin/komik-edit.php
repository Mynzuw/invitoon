...
<html>
  ...
  <body>
      <center>
        <h1>Edit Komik <?php echo $data['judul_komik']; ?></h1>
      <center>
      ...
      <section class="base">
        ...
        <div>
          <label>Cover</label>
          <img src="gambar/<?php echo $data['cover']; ?>" style="width: 120px;float: left;margin-bottom: 5px;">
          <input type="file" name="cover" />
          <i style="float: left;font-size: 11px;color: red">Abaikan jika tidak merubah cover komik</i>
        </div>
        <div>
